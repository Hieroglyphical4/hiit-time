...
class NotificationController {
  ...
  ///  *********************************************
  ///
  static Future<void> initializeLocalNotifications(AwesomeNotifications notifications) async {
    await notifications.initialize(
        null, //'resource://drawable/res_app_icon',//
        [
          NotificationChannel(
            channelKey: 'hiit_time_channel_id',
            channelName: 'Hiit Time Channel',
            ...
            // vibrationPattern: const Int64List(4),
